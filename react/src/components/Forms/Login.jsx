...
import { loginUser , setUser } from '../Redux/usersSlice';
...
const Logine = () => {
  ...
  return (
    <>
      ...
      {errorLogine && !loading && (
        <div className="absolute z-50 mb-[15%] ml-[2%] lg:w-[30%] rounded-lg lg:ml-[30%] bg-orange-100 border-l-4 border-orange-500 text-orange-700 lg:p-4" role="alert">
